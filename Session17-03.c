...
int main(void){
    ...
    do{
    	...
    	printf("4. Nhap vao chuoi khac , so sanh chuoi do voi chuoi ban dau (ngan hon hoac dai hon chuoi ban dau) \");
    	printf("5. In hoa tat ca chu cai trong chuoi \n");
    	printf("6. Nhap vao mot chuoi khac va them va them chuoi do vao chuoi do vao chuoi ban dau \n");
    	printf("7. Thoat \n");
